...
github.com/lwplvx/gorm-dm/panwei/pgx/v5/stdlib to use pgx as a database/sql compatible driver. See that package's documentation for
details.
...
github.com/lwplvx/gorm-dm/panwei/pgx/v5/pgxpool for a concurrency safe connection pool.
...
For debug tracing of the actual PostgreSQL wire protocol messages see github.com/lwplvx/gorm-dm/panwei/pgx/v5/pgproto3.

Lower Level PostgreSQL Functionality

github.com/lwplvx/gorm-dm/panwei/pgx/v5/pgconn contains a lower level PostgreSQL driver roughly at the level of libpq. pgx.Conn in
